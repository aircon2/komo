import svgPaths from "./svg-fl3ymrnpwd";
    ...
    <div className="relative shrink-0 size-[24.02px]">
      <div className="absolute inset-[-5.71%_-11.43%_-17.14%_-11.43%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 30 30">
          <g id="Group 75">
            <g filter="url(#filter0_d_3_2523)" id="Rectangle 1">
          ...
          <defs>
            <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="29.5098" id="filter0_d_3_2523" width="29.5098" x="0" y="0">
              ...
              <feBlend in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_3_2523" />
              <feBlend in="SourceGraphic" in2="effect1_dropShadow_3_2523" mode="normal" result="shape" />
            </filter>
          </defs>
        </svg>
      </div>
